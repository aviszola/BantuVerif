...
const statusFilters: { key: StatusFilter; label: string; count?: number }[] = [
  { key: "all", label: "All", count: verificationQueue.length },
  { key: "urgent", label: "Urgent", count: 2 },
  { key: "pending", label: "Pending", count: 3 },
  { key: "in_review", label: "In Review", count: 2 },
      ...
      <main className="md:ml-64 min-h-screen">
        ...
        <div className="pt-8 pb-12 px-4 md:px-gutter max-w-container-max mx-auto">
          ...
          <div className="mb-8 flex flex-col md:flex-row md:items-end justify-between gap-4">
            <div>
              ...
              <p className="text-on-surface-variant text-sm md:text-base max-w-2xl leading-relaxed">
                Review and manage all pending community verification cases
            ...
            <div className="mb-6 p-4 bg-danger/5 border border-danger/20 rounded-xl flex items-center gap-4">
              ...
              <div className="flex-1">
                <p className="text-sm font-bold text-danger">
                  {urgentCount} Urgent Case{urgentCount > 1 ? "s" : ""} Require Immediate Action
                </p>
                <p className="text-xs text-on-surface-variant mt-0.5">
                  Cases expiring within 4 hours need your vote to meet consensus threshold.
                </p>
              </div>
              <button
                type="button"
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
            {[
              { label: "Total Queue", value: verificationQueue.length, color: "text-on-surface" },
              {
                label: "Urgent",
          ...
          <div className="space-y-3">
            {filtered.length === 0 ? (
              <div className="bg-surface border border-border-subtle rounded-xl p-12 text-center shadow-level1">
                ...
                <p className="font-semibold text-on-surface-variant">No cases match your filter.</p>
                <p className="text-xs text-on-surface-variant mt-1">Try adjusting the status filter or search query.</p>
              </div>
            ) : (
              filtered.map((item) => {
                  ...
                  >
                      ...
                      {isActive && (
                        <div className="mt-3 flex items-center gap-3">
                          ...
                          <span className="text-[11px] text-on-surface-variant font-semibold flex items-center gap-1">
                            ...
                            {item.votes}/{item.totalVotes} votes
                          </span>
                        </div>
                      )}
                    </div>
                    ...
                    <div className="flex items-center gap-4 shrink-0">
                      ...
                      <div className="text-right hidden sm:block">
                        ...
                        <p className="text-[10px] text-on-surface-variant">deadline</p>
                      </div>
